...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Edition of Course') }}</div>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('course.update', ['course' => $course]) }}" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PUT') }}
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="courseName" type="text" class="form-control @error('courseName') is-invalid @enderror" name="courseName" value="{{ $course->name}}" required autocomplete="courseName" autofocus>
                        ...
                        <div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8" id="input-advantage-list">
                                    @foreach($course->advantages as $advantage)
                                    <input class="form-control" type='text' name='advantages[]' value="{{$advantage->name}}">
                                    <br>
                                    @endforeach
                                </div>
                        ...
                        <div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 mb-0" id="input-output-list">
                                    ...
                                    <input class="form-control" type='text' name='outputs[]' value="{{$staff->name}}">
                                    <br>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 mb-0" id="input-courseType-list">
                                    ...
                                    <input class="form-control" type='text' name='courseTypes[]' value="{{$type->name}}">
                                    <br>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 mb-0" id="input-price-list">
                                    ...
                                    <input class="form-control" type='text' name='prices[]' value="{{$price->name}}">
                                    <br>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 mb-0" id="input-duration-list">
                                    @foreach($course->classRates as $duration)
                                    <input class="form-control" type='text' name='durations[]' value="{{$duration->name}}">
                                    <br>
                                    @endforeach
                                </div>
                            </div>
